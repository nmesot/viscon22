...
public enum AccountDataEnum {
	...
	AccountDataEnum(String accountId, String surname, String lastname, String street, String city, Long pan, String cardType) {
	...
	public static Account getRandomAccount() {
		return getAccount(getRandomEnum());
	}

	private static AccountDataEnum getRandomEnum() {
		return AccountDataEnum.values()[new SecureRandom().nextInt(AccountDataEnum.values().length)];
	}

	private static Account getAccount(AccountDataEnum accountEnum) {
		return new Account(
				accountEnum.getAccountId(),
				accountEnum.getSurname(),
				accountEnum.getLastname(),
				accountEnum.getStreet(),
				accountEnum.getCity(),
				accountEnum.getPan(),
				accountEnum.getCardType());
	}
